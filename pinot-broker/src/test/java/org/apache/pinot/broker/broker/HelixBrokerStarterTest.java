...
public class HelixBrokerStarterTest extends ControllerTest {
  ...
  public void setUp()
    ...
    _properties.addProperty(CommonConstants.Helix.KEY_OF_BROKER_QUERY_PORT, 8943);
    _properties.addProperty(CommonConstants.Broker.CONFIG_OF_BROKER_REFRESH_TIMEBOUNDARY_INFO_SLEEP_INTERVAL, 100L);
    _helixBrokerStarter = new HelixBrokerStarter(_properties, getHelixClusterName(), ZkStarter.DEFAULT_ZK_STR);
  ...
  public void testTimeBoundaryUpdate()
    ...
    }, 5 * _properties.getLong(CommonConstants.Broker.CONFIG_OF_BROKER_REFRESH_TIMEBOUNDARY_INFO_SLEEP_INTERVAL));
